...
struct Fake_sdm_msr : public Fake_msr_base
{
    public:
        ...
        static uint64 read (Register r)
        {
            ...
            case 0x0fe: res = 0x0000000000001d0aULL; break;
            case 0x2ff: res = 0x0000000000000c00ULL; break;
            case 0x250: res = 0x0606060606060606ULL; break;
            case 0x258: res = 0x0606060606060606ULL; break;
            case 0x259: res = 0x0000000000000000ULL; break;
            case 0x268: res = 0x0505050505050505ULL; break;
            case 0x269: res = 0x0505050505050505ULL; break;
            case 0x26a: res = 0x0505050505050505ULL; break;
            case 0x26b: res = 0x0505050505050505ULL; break;
            case 0x26c: res = 0x0505050505050505ULL; break;
            case 0x26d: res = 0x0505050505050505ULL; break;
            case 0x26e: res = 0x0505050505050505ULL; break;
            case 0x26f: res = 0x0505050505050505ULL; break;
            case 0x200: res = 0x0000000000000006ULL; break;
            case 0x201: res = 0x0000000FFC000800ULL; break;
            case 0x202: res = 0x0000000004000006ULL; break;
            case 0x203: res = 0x0000000FFE000800ULL; break;
            case 0x204: res = 0x0000000006000006ULL; break;
            case 0x205: res = 0x0000000FFFC00800ULL; break;
            case 0x206: res = 0x0000000004000000ULL; break;
            case 0x207: res = 0x0000000FFFC00800ULL; break;
            case 0x208: res = 0x0000000000F00000ULL; break;
            case 0x209: res = 0x0000000FFFF00800ULL; break;
            case 0x20A: res = 0x00000000A0000001ULL; break;

...
public:
    ...
    CPULOCAL_REMOTE_ACCESSOR(cpu, block_nmis);

    // Access the block_nmi flag on a remote core. Has to be accessed using atomic ops!
    static bool& block_nmis(unsigned cpu) { return remote_ref_block_nmis(cpu); }
